...
\end{verbatim}
\section{File System}
\label{sec:org2a824f0}

\subsection{Auto-Revert}
\label{sec:org211a506}
...
\label{sec:orgb72eeaf}

\subsection{Remove Clutter}
\label{sec:org760e194}
...
\end{verbatim}
\section{Formatting}
\label{sec:orga8fa949}

\subsection{Tabs}
\label{sec:org050899a}
...
\label{sec:orgbc4643d}

\subsection{On The Fly Syntax Checking}
\label{sec:orge9ace50}
