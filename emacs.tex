...
\section{Packages}
\label{sec:org291a474}

\subsection{Melpa}
\label{sec:org1383397}
...
\end{verbatim}
\section{File System}
\label{sec:org6d92fdc}

\subsection{Auto-Revert}
\label{sec:org74e421a}
...
\label{sec:org4b82df0}

\subsection{Remove Clutter}
\label{sec:org8631781}
...
\label{sec:org419942f}

\subsection{Git/Magit}
\label{sec:orgd8fed48}
...
\section{LSP}
\label{sec:org2412bc2}

\subsection{Background}
\label{sec:orgecad585}
...
\end{verbatim}
\section{Formatting}
\label{sec:orgd231a9a}

\subsection{Tabs}
\label{sec:org70df268}
...
\label{sec:org356a99f}

\subsection{On The Fly Syntax Checking}
\label{sec:org41a0ebb}
...
\section{Languages}
\label{sec:orgf585489}

\subsection{Rust}
\label{sec:org0e51935}
...
\label{sec:org287d40d}

\subsection{Interactive Commands}
\label{sec:orgc567b6b}
