...
.PHONY: all jj-test gptel-ops-test checkdoc byte-compile test
...
gptel-ops-test:
	$(EMACS) -Q --batch -l user-lisp/gptel-ops-tests.el -f ert-run-tests-batch-and-exit
